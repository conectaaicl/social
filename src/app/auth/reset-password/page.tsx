    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-gray-300">Enlace inválido o expirado.</p>
          <Link href="/auth/forgot-password" className="text-indigo-400 text-sm mt-3 inline-block">Solicitar nuevo enlace</Link>
        </div>
      </div>
    )
  }
